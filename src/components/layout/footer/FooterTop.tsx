  ...
  return (
    <div className='w-full h-auto md:flex md:flex-row flex-col  text-white bg-primary'>
      <div className='md:w-[50%] w-full h-full md:px-28 px-12 md:py-20 py-10 space-y-4'> 
        ...
        <p className='text-gray-500'>Experience the power of AI for effortless travel booking, smart shopping, and seamless bill payments. Stay organized, save time, and enjoy a hassle-free digital assistant at your fingertips.</p>
