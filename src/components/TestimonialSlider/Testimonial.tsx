    ...
    <div>
        <div className="text-black flex flex-col gap-5 justify-center items-center lg:py-10 pt-8 pb-2">
         ...
         Testimonials
          ...
          <h1 className="mt-1 xl:text-4xl md:text-3xl items-center text-center sm:text-4xl text-2xl font-black tracking-wider leading-tight">
          What our Happy User <br /> Says
          </h1>
        </div>
        <SwiperExample/>
      </div>
